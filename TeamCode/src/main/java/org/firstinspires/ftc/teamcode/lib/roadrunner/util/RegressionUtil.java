...
public class RegressionUtil {
   ...
   *
   * <p>Here's the general procedure for gathering the requisite data: 1. Slowly ramp the motor
  ...
  public static RampResult fitRampData(
    ...
    return new RampResult(
        Math.abs(rampReg.getSlope()), Math.abs(rampReg.getIntercept()), rampReg.getRSquare());
  }
